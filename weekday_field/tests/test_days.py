...
class TestToggleCheckboxes(TestCase):
    def test_render_widget(self):
        ...
        self.assertHTMLEqual(
            ...
            <li><label><input type="checkbox" name="Test Widget Name" value="0" class=" advanced-weekday-field" checked />
            Monday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="1" class=" advanced-weekday-field" checked />
            Tuesday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="2" class=" advanced-weekday-field" checked />
            Wednesday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="3" class=" advanced-weekday-field" checked />
            Thursday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="4" class=" advanced-weekday-field" checked />
            Friday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="5" class=" advanced-weekday-field" />
            Saturday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="6" class=" advanced-weekday-field" />
            Sunday</label>
            </li>
            </ul>
            ''',
        ...
        self.assertHTMLEqual(
            ...
            <li><label><input type="checkbox" name="Test Widget Name" value="5" class=" advanced-weekday-field" checked />
            Saturday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="6" class=" advanced-weekday-field" checked />
            Sunday</label>
            </li>
            </ul>
            ''',
        ...
        self.assertHTMLEqual('''
            <ul class=" advanced-weekday-field">
            <li><label><input type="checkbox" name="Test Widget Name" value="0" class=" advanced-weekday-field" />
            Monday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="1" class=" advanced-weekday-field" />
            Tuesday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="2" class=" advanced-weekday-field" />
            Wednesday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="3" class=" advanced-weekday-field" />
            Thursday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="4" class=" advanced-weekday-field" />
            Friday</label>
            </li>
            <li><label><input type="checkbox" name="Test Widget Name" value="5" class=" advanced-weekday-field" checked />
            Saturday</label>
